...
Z čeho se skládá Apachce Hadoop framework? 
...
Jak funguje Hadoop HDFS?

Back:

- NameNode (master node) - obsahuje metadata
	- Secondary NameNode - reduce start-up time after restart
- DataNode - obsahují samotná data s
...
Jaké je srovnání relational databases a hadoopu
...
Co je on premise data platform?
